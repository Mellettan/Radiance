...
class SubsViewTest(TestCase):
    ...
    включая отображение подписок, поиск пользователей, пагинацию и работу с
    ...
    def test_pagination(self):
        ...
        Создает дополнительного пользователя и проверяет, что при запросе первой
        страницы пагинации отображаются только пользователи, подходящие под запрос.
        """
        self.client.force_login(self.user1)
