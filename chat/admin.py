...
class MessageAdmin(admin.ModelAdmin):
    ...
    Attributes:
        list_display (list): Список полей, которые будут отображаться в административной панели.
        search_fields (list): Список полей, которые будут использоваться для поиска в административной панели.
        list_filter (list): Список полей, которые будут использоваться для фильтрации в административной панели.
