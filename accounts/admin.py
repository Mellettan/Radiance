...
class CustomUserAdmin(UserAdmin):
    ...
    Attributes:
        ...
        list_filter: поля, которые будут использоваться для фильтрации в
            представлении списка.
        search_fields: поля, которые будут использоваться для поиска в
            представлении списка.
        ordering: поля, которые будут использоваться для упорядочивания в
            представлении списка.
        fieldsets: наборы полей, которые будут отображаться в формах
            добавления/изменения.
        add_fieldsets: наборы полей, которые будут отображаться в форме
            добавления.
        inlines: встроенные панели, которые будут отображаться в формах
            добавления/изменения.
    """

    def get_following(self, obj: CustomUser) -> str:
        """
        Возвращает разделенную запятыми строку из адресов электронной
        почты пользователей, на которых подписан данный пользователь.
    ...
    def get_followers(self, obj: CustomUser) -> str:
        """
        Возвращает разделенную запятыми строку из адресов электронной почты
        пользователей, которые подписаны на данного пользователя.
