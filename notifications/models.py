...
class Notification(models.Model):
    ...
    Эта модель описывает структуру уведомлений, которые могут быть отправлены
    пользователям.
    Уведомление содержит тему, сообщение, информацию о дате создания и статус прочтения.

    Attributes:
        user (ForeignKey): Пользователь, к которому относится уведомление.
        ...
        is_read (BooleanField): Флаг, указывающий, прочитано уведомление или нет.
            По умолчанию - False.
    """
    ...
    def __str__(self):
        ...
        Returns:
            str: Строка, содержащая адрес электронной почты пользователя и
                текст сообщения.
        """
