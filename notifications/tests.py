...
class NotificationViewTest(TestCase):
    ...
    def setUp(self):
        ...
        self.other_user = CustomUser.objects.create_user(email='otheruser@example.com', password='password')
    ...
    def test_login_required(self):
        ...
        self.assertRedirects(response, f"/accounts/login/?next={reverse('notifications:notifications')}")
...
class SignalTests(TestCase):
    ...
    def setUp(self):
        ...
        """
        self.user1 = CustomUser.objects.create_user(email='user1@example.com', username='user1', password='password')
        self.user2 = CustomUser.objects.create_user(email='user2@example.com', username='user2', password='password')
    ...
    def test_create_notification_on_follow(self):
        ...
        self.assertIn(reverse('posts:home', kwargs={'pk': self.user1.pk}), notification.message)
