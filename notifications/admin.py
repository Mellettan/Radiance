...
class NotificationAdmin(admin.ModelAdmin):
    ...
    Определяет, как объекты модели Notification будут отображаться и управляться в админ-панели Django.

    Attributes:
        list_display (tuple): Поля модели Notification, которые будут отображаться в списке объектов.
