...
class UserInfoViewTest(TestCase):
    ...
    def test_no_avatar_update(self):
        """
        Проверяет, что аватар пользователя не изменяется при отсутствии загрузки нового файла.
    ...
    def test_unauthorized_access(self):
        """
        Проверяет, что неавторизованный пользователь может получить доступ к странице информации,
